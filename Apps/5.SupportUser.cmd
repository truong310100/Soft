...
echo  ^|  3. Optimize Windowns = Nhấn phím Q  ^|________________________________________^|
echo  ^|  4. Googledrive       = Nhấn phím R  ^|           Thoát = Nhấn phím S          ^|
echo  ^|______________________________________^|________________________________________^|
echo.

choice /N /C ABCDEFGHIJKLMNOPQRS /M "* Nhập Lựa Chọn Của Bạn : "

if ERRORLEVEL  19 goto  :Exit S
