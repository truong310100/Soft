...
# Lưu lại file Excel
filename = f'FileExport/BBGN-{input_username}-{date_string}.xlsx'
workbook.save(filename)
os.system("start "" FileExport")
subprocess.run(['start', '', filename], shell=True)

# Mở Sharepoint và lấy file kết quả excel
webbrowser.open('https://hunghaugroup.sharepoint.com/:f:/g/HHH.HungHauHoldings/Es1sMfxQCtJMvZjz8MH6trMBy-xO3boUBPP0wb6Tz-B2qg?e=DZ18AI')